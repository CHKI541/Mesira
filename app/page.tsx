    ...
    <div className="flex-1 flex flex-col md:flex-row gap-5">
      ...
      <aside className="w-full md:w-56 shrink-0 flex flex-col gap-4">
        ...
        <div className="bg-blue-50/50 border border-blue-150 rounded p-4 shadow-sm text-xs text-blue-800 leading-relaxed">
          ...
          <p className="mb-2">Para evitar spam, cada producto se desactiva automáticamente al recibir <strong>3 contactos</strong>.</p>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-ml-bg flex flex-col pb-16">
      <Header onOpenAuthModal={() => setIsAuthOpen(true)} />
      
      <main className="max-w-6xl mx-auto px-4 w-full mt-5 flex-1 flex flex-col md:flex-row gap-5">
